...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:KmXmYxpeSUNaHsqKtsqLoITglqnaitGe@interchange.proxy.rlwy.net:25318/railway")

# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:KmXmYxpeSUNaHsqKtsqLoITglqnaitGe@interchange.proxy.rlwy.net:25318/railway"
